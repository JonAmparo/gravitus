...
export const addWorkout = (formData, history) => async dispatch => {
  try {
    ...
    const res = await axios.put('/api/profile/workout', formData, config);
...
export const deleteWorkout = id => async dispatch => {
  try {
    const res = await axios.delete(`/api/profile/workout/${id}`);
...
export const addWorkoutExercise = (formData, history) => async dispatch => {
  try {
    const config = {
      headers: {
        'Content-Type': 'application/json'
